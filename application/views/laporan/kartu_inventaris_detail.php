                ...
                <div class="col-md-3">
                  ...
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="card-title m-0 me-2">Daftar Kartu Inventaris di ruang <b><?=getNamaRuanganKir($id_ruangan_kir)->nama_ruangan.'</b> ('.@$office->nama.' '.@$sub_office->nama.')'?></h5>
                    </div>
                    <div class="card-body">
                  ...
                  <table class="table table-hover">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center">Total Inventaris</th>
                      </tr>
                    </thead>
