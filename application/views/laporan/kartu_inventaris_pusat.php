                ...
                <div class="col-md-3">
                  ...
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="card-title m-0 me-2">Kartu Inventaris Pusat</h5>
                    </div>
                    <div class="card-body">
                  ...
                  <table class="table table-hover">
                    <thead>
                      <tr>
                        <th>#</th>
                        <th>Nama Kantor</th>
                        <th class="text-center">Jumlah Kartu Inventaris</th>
                      </tr>
                    </thead>
                    <tbody class="table-border-bottom-0">
                      <?php $no=1; foreach($sub_kantor as $datar):?>
                        <tr onclick="buka('<?=base_url('laporan/kartu_inventaris_list/1/').$datar->sub_id?>')" style="cursor: pointer;">
                          <th><?=$no?></th>
                          <th><?=$datar->nama?></th>
                          <th class="text-center"><span class="badge badge-center rounded-pill bg-secondary"><?= count_kartu_inventaris(1,$datar->sub_id)?></span></th>
                        </tr>
                        <?php $no++; endforeach;?>
                    </tbody>
                  </table>
