...
<body>
    ...
    <center><u><b>
                <h3>KARTU INVENTARIS RUANGAN <br>(KIR)</h3>
            </b></u></center>
    ...
    <table style="width: 100%; border: 1px solid black; border-collapse: collapse;">
        <thead>
            <tr>
                ...
                <td class="border">
                    <center><b>Tahun Perolehan</b></center>
                </td>
                <td class="border">
    ...
    <table style="width: 100%; margin-top:75px">
        <tr>
            ...
            <td style="width: 33%;">
                <center>Diketahui,</center>
            </td>
            <td style="width: 33%;">
                <center>Penanggung Jawab Ruangan,</center>
            </td>
        </tr>
        <tr>
            <td style="width: 33%;">
            ...
            <td style="width: 33%;">
                <center><?= $kartu_inventaris->jabatan_penanggung_jawab ?></center>
            </td>
        </tr>
    </table>
    <table style="width: 100%; margin-top:75px;">
        <tr>
            <td style="width: 33%;">
                <center><b><u><?= $kartu_inventaris->nama_kadiv_umum ?></u></b></center>
            </td>
            <td style="width: 33%;">
                <center><b><u><?= $kartu_inventaris->nama_kasub_aset ?></u></b></center>
            </td>
            <td style="width: 33%;">
                <center><b><u><?= $kartu_inventaris->nama_penanggung_jawab ?></u></b></center>
            </td>
        </tr>
        <tr>
            <td style="width: 33%;">
                <center>NIK. <?= $kartu_inventaris->nik_kadiv_umum ?></center>
            </td>
            <td style="width: 33%;">
                <center>NIK. <?= $kartu_inventaris->nik_kasub_aset ?></center>
            </td>
            <td style="width: 33%;">
                <center>NIK. <?= $kartu_inventaris->nik_penanggung_jawab ?></center>
            </td>
        </tr>
    </table>
    <table style="width: 100%; margin-top:30px;">
        <tr>
            <td>
                <center>Mengetahui / Menyetujui</center>
            </td>
        </tr>
        <tr>
            <td>
                <center>Direktur PAM Tirta Kamuning</center>
            </td>
        </tr>
    </table>
    <table style="width: 100%; margin-top:75px;">
        <tr>
            <td>
                <center><b><u><?= $kartu_inventaris->nama_direktur ?></u></b></center>
            </td>

        </tr>
        <tr>
            <td>
                <center>NIK. <?= $kartu_inventaris->nik_direktur ?></center>
            </td>
        </tr>
    </table>
</body>
