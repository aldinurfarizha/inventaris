...
<body>
    ...
    <center><b>
            <h3><u>BERITA ACARA SERAH TERIMA BARANG INVENTARIS</u></h3>
        </b>
    ...
    ?>
        <p class="item"><b>-<?= 'Satu' . ' (1) ' . $barang->satuan . ' ' . $barang_nama . ' (' . $barang->nama_ruangan_kir . ')' ?> </b></p>
    <?php endforeach; ?>
    ...
    <table style="width: 100%; margin-top:65px;">
        <tr>
            <td style="width: 50%;">
                <center><u><b><?= $berita_acara->pihak_kedua_nama ?></b></u></center>
            </td>
            <td style="width: 50%;">
                <center><u><b><?= $berita_acara->sub_div_rt_nama ?></b></u></center>
            </td>
        </tr>
        <tr>
            <td style="width: 50%;">
                <center>NIK. <?= $berita_acara->pihak_kedua_nik ?></center>
            </td>
            <td style="width: 50%;">
                <center>NIK. <?= $berita_acara->sub_div_rt_nik ?></center>
            </td>
        </tr>
    </table>
    ...
    <table style="width: 100%; margin-top:65px;">
        <tr>
            <td>
                <center><u><b><?= $berita_acara->kadiv_umum_nama ?></b></u></center>
            </td>

        </tr>
        <tr>
            <td>
                <center>NIK. <?= $berita_acara->kadiv_umum_nik ?></center>
            </td>
        </tr>
    </table>
