...
<body>
    ...
    <center><b><h3><u>BERITA ACARA PENGHAPUSAN ASET</u></h3></b>
    ...
    <table style="width: 100%; margin-top:50px">
        <tr>
            <td style="width: 50%;"><center><b>KEPALA SUB DIVISI ASET</b></center></td>
            <td style="width: 50%;"><center><b>KEPALA DIVISI UMUM</b></center></td>
        </tr>
    </table>
    <table style="width: 100%; margin-top:65px;">
        <tr>
            <td style="width: 50%;"><center><u><b><?=$penghapusan->nama_kasub_aset?></b></u></center></td>
            <td style="width: 50%;"><center><u><b><?=$penghapusan->nama_kadiv_umum?></b></u></center></td>
        </tr>
        <tr>
            <td style="width: 50%;"><center>NIK. <?=$penghapusan->nik_kasub_aset?></center></td>
            <td style="width: 50%;"><center>NIK. <?=$penghapusan->nik_kadiv_umum?></center></td>
        </tr>
    </table>
    <table style="width: 100%; margin-top:50px">
        <tr>
            <td style="width: 50%;"><center><b>KEPALA DIVISI SPI</b></center></td>
            <td style="width: 50%;"><center><b>PLT DIREKTUR PAM TIRTA KAMUNING</b></center></td>
        </tr>
    </table>
    <table style="width: 100%; margin-top:65px;">
        <tr>
            <td style="width: 50%;"><center><u><b><?=$penghapusan->nama_kadiv_spi?></b></u></center></td>
            <td style="width: 50%;"><center><u><b><?=$penghapusan->nama_direktur?></b></u></center></td>
        </tr>
        <tr>
            <td style="width: 50%;"><center>NIK. <?=$penghapusan->nik_kadiv_spi?></center></td>
            <td style="width: 50%;"><center>NIK. <?=$penghapusan->nik_direktur?></center></td>
        </tr>
    </table>
