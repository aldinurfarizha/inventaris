      ...
      <div class="row">
        <div class="col-md-6 order-0">
          <div class="card h-100">
            ...
            <div class="card-body">
              <ul class="p-0 m-0">
                <?php foreach ($perkiraan_dasar as $perkiraan) : ?>
                  <li class="d-flex mb-4 pb-1">
                    <div class="avatar flex-shrink-0 me-3">
                      <span class="avatar-initial rounded bg-label-primary"><i class="fa fa-circle"></i></span>
                    </div>
                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                      <div class="me-2">
                        <h6 class="mb-0"><?= $perkiraan->nama_perkiraan_dasar ?></h6>
                      </div>
                      <div class="user-progress">
                        <small class="fw-semibold"><?= countPerkiraanDasar($perkiraan->kd_perkiraan_dasar) ?></small>
                      </div>
                    </div>
                  </li>
                <?php endforeach; ?>
