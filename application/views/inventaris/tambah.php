              ...
              <form id="form_add">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="keterangan" id="keterangan" placeholder="misal:plat nomor atau ciri khusus" aria-describedby="defaultFormControlHelp">
