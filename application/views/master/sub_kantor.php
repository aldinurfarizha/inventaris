                ...
                <div class="col-md-3">
                  ...
                  <div class="col-md-12">
                    <button type="button" class="btn btn-primary disabled" data-bs-toggle="modal" data-bs-target="#basicModal">
                      <i class="fa fa-plus"></i>Sub Kantor (Sinkron Otomatis dengan Simpeg)
                    </button>
                    <hr>
                     ...
                     <?php $no=1; foreach($data as $datar):?>
                        <tr>
                          ...
                          <td class="text-center">
                            <button type="button" onclick="hapus(<?=$datar->sub_id?>)" class="btn btn-sm btn-icon btn-danger disabled">
                              <span class="fa fa-trash"></span>
                              </button>
                             <button type="button" onclick="edit('<?=$datar->sub_id?>','<?=$datar->nama?>','<?=$datar->kepala?>','<?=$datar->nik?>')" class="btn btn-sm btn-icon btn-success disabled">
