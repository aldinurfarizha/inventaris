                    ...
                    <tbody class="table-border-bottom-0">
                      <?php $no=1; foreach($kantor as $datar):?>
                        <?php if($datar->of_id==1){?>
                          <tr onclick="buka('<?=base_url('master/ruangan_kir_pusat/')?>')" style="cursor: pointer;">
                        <?php }else{?>
                        <tr onclick="buka('<?=base_url('master/ruangan_kir_detail/').$datar->of_id?>')" style="cursor: pointer;">
                        <?php } ?>
                          <th><?=$no?></th>
                          <th><?=$datar->nama?></th>
                          <th class="text-center"><span class="badge badge-center rounded-pill bg-secondary"><?= count_ruangan_kir($datar->of_id)?></span></th>
                        </tr>
                        <?php $no++; endforeach;?>
                    </tbody>
                  </table>
