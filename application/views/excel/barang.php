...
<body>
	...
	header("Content-Disposition: attachment; filename=SIMBA Laporan Barang".date('Y-m-d').".xls");
	?>
    <center><h3>Laporan Barang</h3></center>
    ...
    <thead>
        <tr>
            ...
            <td class="border"><center><b>Lokasi</b></center></td>
